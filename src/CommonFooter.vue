            ...
            >
                <section class="lg:col-span-3">
                    <div class="flex items-center space-x-3">
                        <Icon class="h-9 w-9 text-white" name="footer-logo" :size="36" />
                            ...
                            >
                                ...
                                <template #reference>
                                    <a
                                        ...
                                        href="javascript:;"
                                    >
                                        <Icon class="h-5 w-5" :name="item.icon" :size="20" />
                                    </a>
                                </template>
                            </el-popover>
                            <a
                                ...
                                <template #reference>
                                    ...
                                    >
                                        <span class="mr-2.5 flex h-4 w-4 items-center justify-center">
                                            <Icon class="h-4 w-4" :name="item.icon" :size="16" />
                                        </span>
                                        <span>{{ item.name }}</span>
                                    </a>
                                </template>
...
<script>
import mpQr from "../assets/img/mobile/mp.jpg";
import miniProgramQr from "../assets/img/mobile/miniprogram.jpg";
